...
def attack(char_name: str, char_class: str) -> str:
    """Функция описывает действие атаки для классов."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция описывает действие защиты для классов."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает действие ульты классов."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора игрового класса."""
    approve_choice: str = ''
    char_class: str = ''
